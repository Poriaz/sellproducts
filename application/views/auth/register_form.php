...
<head>
<title>Food Euipments : Register</title>
			...
			<div class="box01">
				<div class="login-window">
					...
					<div class="row left10">
						...
						<form accept-charset="utf-8" method="post" class="nicely" action="http://collab-o-nation.com/developers/foodequipments/index.php/auth/register">
