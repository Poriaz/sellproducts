...
{
	protected $scope = array('email','user_about_me','public_profile');
	...
	public function get_user_info(OAuth2_Token_Access $token)
	{
		$url = 'https://graph.facebook.com/me?'.http_build_query(array(
			...
			'fields'=>'first_name,last_name,email,name,link',
		));

		$user = json_decode(file_get_contents(str_replace('index.php/index.php','index.php',$url)));
