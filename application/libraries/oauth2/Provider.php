	...
	*/	
	public function authorize($options = array())
	{
		...
		$params = array(
			...
			'redirect_uri' 		=> isset($options['redirect_uri']) ? str_replace('index.php/index.php','index.php',$options['redirect_uri']) : str_replace('index.php/index.php','index.php',$this->redirect_uri),
			'state' 			=> $state,
	...
	public function access($code, $options = array())
	{
		...
		switch ($this->method)
		{
			case 'GET':
				...
				$url = str_replace('index.php%2Findex.php','index.php',$url);
			...
			case 'POST':
				...
				*/
				...
				$params['redirect_uri'] = str_replace('index.php/index.php','index.php',$params['redirect_uri']);
